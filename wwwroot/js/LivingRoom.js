...
function openFormSafe() {
    document.getElementById("form-Safe").style.display = "block";
}
...
function press(numVal) {
    ...
    document.getElementById("code").setAttribute('value', disp)
...
let bulbCode = ""
let codeBulb = document.getElementById("bulbCode")
...
light2.addEventListener("click", function () {
    if (light2.classList.contains("blue")) {
        ...
        bulbCode += "1"
        document.getElementById("bulbCode").setAttribute('value', bulbCode)
        console.log(codeBulb)
    } else if (light2.classList.contains("red")) {
        // light2.classList.toggle("yellow")
        light2.classList.replace("red", "yellow")
        bulbCode = bulbCode.slice(0, -1)
        // bulbCode = edit2
...
light3.addEventListener("click", function () {
    if (light3.classList.contains("blue")) {
        ...
        bulbCode = bulbCode.slice(0, -1)
        // const edit2 = bulbCode.slice(0, -1)
        // bulbCode = edit2
